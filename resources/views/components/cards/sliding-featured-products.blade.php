...
class="relative py-20 overflow-hidden bg-primary-900">
    ...
    <div class="container relative px-6 mx-auto">
        <!-- Section Header -->
        <div class="flex flex-col md:items-center mb-16 md:text-center">
            <span class="inline-block px-4 py-2 mb-1 md:mb-4 text-sm font-semibold tracking-widest text-accent-500 uppercase bg-black/20 rounded-full">
                Featured Products
            </span>
            <h2 class="text-3xl font-medium text-white sm:text-5xl md:text-6xl">
                Top Products <span class="text-accent-400">Everybody</span> is Shopping
            </h2>
            <p class="max-w-2xl mt-1 md:mt-4 md:text-lg text-gray-300">
        ...
        <div class="relative w-full">
            <!-- Background Platform -->
            <div class="absolute bottom-0 left-0 right-0 h-1/3 bg-gradient-to-t from-black/80 rounded-2xl to-transparent">
            ...
            <div class="relative w-full" style="min-height: 600px;">
                ...
                <template x-for="(product, index) in products" :key="index">
                    <div x-show="currentSlide === index"
                        ...
                        <!-- Product Card -->
                        <div class="product-card relative w-full max-w-4xl mx-auto bg-black/30 backdrop-blur-sm border border-white/10 rounded-2xl overflow-hidden shadow-2xl transition-all ease-in-out duration-500">
                            <!-- Product Spotlight Effect -->
                            <div class="product-spotlight absolute inset-0 rounded-2xl bg-[radial-gradient(circle_at_center,_transparent_0%,_rgba(245,158,11,0.1)_70%)] pointer-events-none"></div>

                            <div class="grid md:grid-cols-2">
                                <!-- Product Image -->
                                <div class="relative aspect-[4/3] md:aspect-square">
                                    <div class="absolute inset-0 flex items-center justify-center p-4 md:p-8">
                                        <div class="relative z-10 w-full h-full">
                                            ...
                                            <!-- Floating Reflection -->
                                            <div class="absolute bottom-0 left-0 right-0 h-16 md:h-32 bg-gradient-to-t from-accent-300/30 to-transparent"></div>
                                        </div>
                                    </div>
                                    <!-- Decorative Elements -->
                                    <div class="absolute top-4 md:top-8 left-4 md:left-8 w-8 md:w-16 h-8 md:h-16 bg-accent-500/20 rounded-full filter blur-xl"></div>
                                    <div class="absolute bottom-4 md:bottom-8 right-4 md:right-8 w-12 md:w-24 h-12 md:h-24 bg-blue-500/20 rounded-full filter blur-xl"></div>
                                </div>

                                <!-- Product Info -->
                                <div class="flex flex-col justify-center p-4 md:p-8 text-white">
                                    <div class="mb-4">
                                        ...
                                        <h3 class="text-2xl md:text-3xl font-bold" x-text="product.name"></h3>
                                    ...
                                    <!-- Key Features -->
                                    <ul class="my-4 md:my-6 space-y-2 md:space-y-3">
                                        <template x-for="feature in product.features">
                                            <li class="flex items-start">
                                                <i class="mt-1 mr-3 text-accent-400 fas fa-check-circle"></i>
                                                <span class="text-sm md:text-base text-gray-200" x-text="feature"></span>
                                            </li>
                                        </template>
                                    </ul>
                                    ...
                                    <div class="mt-auto pt-4">
                                        <div class="text-3xl md:text-4xl font-bold text-accent-400" x-text="`Ksh ${product.price.toFixed(2)}`"></div>
                                        <button class="w-full px-6 py-3 md:px-8 md:py-4 mt-4 md:mt-6 text-base md:text-lg font-bold text-gray-900 transition-all duration-300 bg-accent-500 rounded-lg hover:bg-accent-600 hover:shadow-lg hover:shadow-accent-500/30">
                                            Add to Cart
                                        </button>
                                    </div>
                                </div>
