<div id="cta-button-sidebar"
    ...
    <div class="min-h-screen px-3 py-10 overflow-y-auto bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-100">
        ...
        <!-- main pages -->
        <div class="mt-6 space-y-2 lg:space-y-3 font-medium text-sm xl:text-base">
            <x-side-link
            ...
            <x-side-link :href="route('products.index')" :active="request()->routeIs('products.index')" wire:navigate>
                ...
                <span class="ms-3">{{ __('Products') }}</span>
            </x-side-link>
        ...
        >
            <button
                ...
                class="w-full inline-flex items-center justify-between px-3 py-2 text-slate-500 dark:text-slate-600 group-hover:text-emerald-500 dark:group-hover:text-emerald-600"
            >
            ...
            <div x-show="expanded" class="w-full flex flex-col gap-3 lg:gap-6 p-2 lg:px-4 bg-slate-100 dark:bg-slate-900 rounded-b">
                <x-side-link :href="route('admin.products')" :active="request()->routeIs('admin.products')" wire:navigate>
                    {{ __('Stock') }}
                </x-side-link>
        ...
        >
            ...
            <div x-show="expanded" class="w-full flex flex-col gap-3 lg:gap-6 p-2 lg:px-4 bg-slate-100 dark:bg-slate-900 rounded-b">
                ...
                <x-side-link :href="route('products.index')" :active="request()->routeIs('products.index')" wire:navigate>
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="w-5 h-5 me-2.5"><path d="M4 10c-1.1 0-2-.9-2-2V4c0-1.1.9-2 2-2h4c1.1 0 2 .9 2 2"/><path d="M10 16c-1.1 0-2-.9-2-2v-4c0-1.1.9-2 2-2h4c1.1 0 2 .9 2 2"/><rect width="8" height="8" x="14" y="14" rx="2"/></svg>
                    {{ __('Subcategories') }}
                </x-side-link>
