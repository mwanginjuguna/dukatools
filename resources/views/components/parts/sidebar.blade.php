<div id="cta-button-sidebar"
     ...
     {{ $attributes }}
     aria-label="Sidebar">
    <div class="h-full px-3 py-4 overflow-y-auto bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-100">
        ...
        <div class="mt-3 p-2 space-y-1">
            ...
            >
                ...
                <span class="ms-3 lg:text-base">{{ __('Dashboard') }}</span>
            </x-side-link>
            ...
            <x-side-link :href="route('vendor.pos')" :active="request()->routeIs('vendor.pos')" wire:navigate>
                ...
                <span class="ms-3 lg:text-base">{{ __('POS') }}</span>
            </x-side-link>
        ...
        <div class="py-1.5 space-y-1 text-sm">
            <div class="py-1 flex items-center text-sm text-slate-400 before:flex-1 before:border-t before:border-slate-200 before:me-3 after:flex-1 after:border-t after:border-slate-200 after:ms-3 dark:text-slate-600 dark:before:border-slate-600 dark:after:border-slate-600">My Shop</div>
            ...
            <div
                ...
                class="text-sm hover:shadow-sm border-slate-100 dark:border-slate-900 hover:shadow-emerald-100 hover:dark:shadow-emerald-800 rounded-lg group"
            >
                <button
                ...
                >
                    ...
                    <svg x-show="!expanded" class="w-5 h-5 ms-2.5" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m9 18 6-6-6-6"/></svg>
                </button>
            ...
            <div
                x-data="{expanded: false}"
                class="text-sm hover:shadow-sm border-slate-100 dark:border-slate-700 hover:shadow-emerald-100 hover:dark:shadow-emerald-800 rounded-lg group"
            >
                <button
                    x-on:click="expanded = ! expanded"
                    :class="expanded ? 'text-emerald-500 dark:text-emerald-600 bg-slate-100 dark:bg-slate-900 ' : 'text-slate-600 dark:text-slate-400 '"
                    class="w-full inline-flex items-center justify-between px-3 py-2 group-hover:text-emerald-500 dark:group-hover:text-emerald-600 transition-all ease-in-out duration-300"
                >
                    <span class="inline-flex items-center"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="w-5 h-5 me-2.5"><path d="M12.22 2h-.44a2 2 0 0 0-2 2v.18a2 2 0 0 1-1 1.73l-.43.25a2 2 0 0 1-2 0l-.15-.08a2 2 0 0 0-2.73.73l-.22.38a2 2 0 0 0 .73 2.73l.15.1a2 2 0 0 1 1 1.72v.51a2 2 0 0 1-1 1.74l-.15.09a2 2 0 0 0-.73 2.73l.22.38a2 2 0 0 0 2.73.73l.15-.08a2 2 0 0 1 2 0l.43.25a2 2 0 0 1 1 1.73V20a2 2 0 0 0 2 2h.44a2 2 0 0 0 2-2v-.18a2 2 0 0 1 1-1.73l.43-.25a2 2 0 0 1 2 0l.15.08a2 2 0 0 0 2.73-.73l.22-.39a2 2 0 0 0-.73-2.73l-.15-.08a2 2 0 0 1-1-1.74v-.5a2 2 0 0 1 1-1.74l.15-.09a2 2 0 0 0 .73-2.73l-.22-.38a2 2 0 0 0-2.73-.73l-.15.08a2 2 0 0 1-2 0l-.43-.25a2 2 0 0 1-1-1.73V4a2 2 0 0 0-2-2z"/><circle cx="12" cy="12" r="3"/></svg> {{__('Shop Settings')}}</span>
        ...
        <!-- vendor sales -->
        <div class="py-1.5 space-y-1 text-sm">
            <div class="py-2 flex items-center text-sm text-slate-400 before:flex-1 before:border-t before:border-slate-200 before:me-3 after:flex-1 after:border-t after:border-slate-200 after:ms-3 dark:text-slate-600 dark:before:border-slate-600 dark:after:border-slate-600">Sales Overview</div>
            ...
            >
                ...
                >
                    <span class="inline-flex items-center">
                        <svg class="w-5 h-5 me-2.5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 4.5V19a1 1 0 0 0 1 1h15M7 14l4-4 4 4 5-5m0 0h-3.207M20 9v3.207"/></svg>
                        {{__('Top Sales')}}</span>

                    <svg x-show="expanded" class="w-5 h-5 ms-2.5 transition-all ease-in-out duration-500" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m18 15-6-6-6 6"/></svg>
                    <svg x-show="!expanded" class="w-5 h-5 ms-2.5 transition-all ease-in-out duration-500" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m9 18 6-6-6-6"/></svg>
                </button>
            ...
            >
                <button
                    ...
                    class="w-full inline-flex items-center justify-between px-3 py-2 group-hover:text-emerald-500 dark:group-hover:text-emerald-600 transition-all ease-in-out duration-500"
                >
                    <span class="inline-flex items-center"><svg class="w-5 h-5 me-2.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="currentColor"><g><path d="M21.007 8.222A3.738 3.738 0 0 0 15.045 5.2a3.737 3.737 0 0 0 1.156 6.583 2.988 2.988 0 0 1-2.668 1.67h-2.99a4.456 4.456 0 0 0-2.989 1.165V7.4a3.737 3.737 0 1 0-1.494 0v9.117a3.776 3.776 0 1 0 1.816.099 2.99 2.99 0 0 1 2.668-1.667h2.99a4.484 4.484 0 0 0 4.223-3.039 3.736 3.736 0 0 0 3.25-3.687zM4.565 3.738a2.242 2.242 0 1 1 4.484 0 2.242 2.242 0 0 1-4.484 0zm4.484 16.441a2.242 2.242 0 1 1-4.484 0 2.242 2.242 0 0 1 4.484 0zm8.221-9.715a2.242 2.242 0 1 1 0-4.485 2.242 2.242 0 0 1 0 4.485z"></path></g></svg> {{__('Sale Channels')}}</span>
        ...
        <!-- vendor inventory -->
        <div class="py-1.5 space-y-1 text-sm">
            <div class="py-2 flex items-center text-sm text-slate-400 before:flex-1 before:border-t before:border-slate-200 before:me-3 after:flex-1 after:border-t after:border-slate-200 after:ms-3 dark:text-slate-600 dark:before:border-slate-600 dark:after:border-slate-600">Inventory</div>
            ...
            <div class="w-full flex flex-col gap-3 mt-2">
                ...
                <x-side-link :href="route('vendor.customers')" :active="request()->routeIs('vendor.customers')" wire:navigate>
                    <svg class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M18 21a8 8 0 0 0-16 0"/><circle cx="10" cy="8" r="5"/><path d="M22 20c0-3.37-2-6.5-4-8a5 5 0 0 0-.45-8.3"/></svg>
