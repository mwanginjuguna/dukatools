...
$classes = ($active ?? false)
            ? 'inline-flex items-center w-full px-2 py-1 border-l-2 border-emerald-400 dark:border-emerald-600 text-sm font-medium leading-5 text-emerald-500 dark:text-emerald-400 focus:outline-none focus:border-emerald-700 transition duration-300 ease-in-out'
