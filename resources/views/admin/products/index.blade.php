<x-app-layout>
    ...
    <section class="max-w-5xl mx-auto px-4 py-8 md:py-12">
        <div class="mx-auto max-w-2xl lg:mx-0">
            <h2 class="text-lg font-bold tracking-tight text-slate-900 dark:text-slate-100 sm:text-xl">Browse Inventory</h2>
            <p class="mt-2 text-xs lg:text-sm leading-8 text-slate-600 dark:text-slate-300">All products, components, parts, and raw materials for your business appear here.</p>
        </div>
        ...
        <div class="mt-6">
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
                <!-- products overview -->
                <div class="flex flex-col bg-slate-100 border border-emerald-100 shadow-sm rounded-xl dark:bg-slate-800 dark:border-emerald-800">
                    <div class="p-4 md:p-5 flex justify-between gap-x-3">
                        <div>
                            ...
                            <div class="mt-1 flex items-center gap-x-2">
                                <h3 class="text-xl sm:text-2xl font-medium text-emerald-500 dark:text-emerald-400">
                                    {{ $products->count() }}
                                </h3>
                            </div>
                        </div>
                        <div class="flex-shrink-0 flex justify-center items-center size-[46px] bg-emerald-50 text-emerald-500 rounded-full dark:bg-emerald-900 dark:text-emerald-100">
                ...
                <div class="flex flex-col bg-slate-100 border shadow-sm border-emerald-100 rounded-xl dark:bg-slate-800 dark:border-emerald-800">
                    <div class="p-4 md:p-5 flex justify-between gap-x-3">
                        ...
                        <div class="flex-shrink-0 flex justify-center items-center size-[46px] bg-emerald-50 text-emerald-600 rounded-full dark:bg-emerald-900 dark:text-emerald-200">
                            <svg class="w-6 h-6" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                ...
                <div class="flex flex-col bg-slate-100 border border-emerald-100 shadow-sm rounded-xl dark:bg-slate-800 dark:border-emerald-800">
                    <div class="p-4 md:p-5 flex justify-between gap-x-3">
                        <div>
                            ...
                            <div class="mt-1 flex items-center gap-x-2">
                                <h3 class="mt-1 text-xl font-medium text-emerald-500 dark:text-emerald-400">
