        ...
        <div class="py-4 grid lg:grid-cols-4 gap-4 items-center">
            <div class="hidden lg:col-span-2 grid md:grid-cols-2 gap-6 items-center">
                ...
                <x-cards.simple-stats-card title="Total Revenue">
                    <x-slot:svg>
                        <svg class="w-6 h-6 text-emerald-500 dark:text-emerald-600" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                    ...
                    <div class="space-y-1">
                        <h3 class="mb-1 text-xl font-medium text-amber-700 dark:text-amber-500">
                            {{ config('app.currency_symbol'). ' '. number_format($orders->sum('total'), 2) }}
                        </h3>
                        <p class="text-xs text-slate-600 dark:text-slate-300">
                            Units sold: ({{ $purchasedProducts }}) <span class="ms-1 inline-flex items-center gap-1.5 py-1 px-2 rounded-md text-xs font-medium bg-emerald-300 text-slate-800 dark:bg-emerald-700 dark:text-slate-100">
                ...
                <!-- Total sales Card -->
                <x-cards.simple-stats-card title="Total Sales">
                    <x-slot:svg>
                        <svg class="w-6 h-6 text-emerald-500 dark:text-emerald-600" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8.891 15.107 15.11 8.89m-5.183-.52h.01m3.089 7.254h.01M14.08 3.902a2.849 2.849 0 0 0 2.176.902 2.845 2.845 0 0 1 2.94 2.94 2.849 2.849 0 0 0 .901 2.176 2.847 2.847 0 0 1 0 4.16 2.848 2.848 0 0 0-.901 2.175 2.843 2.843 0 0 1-2.94 2.94 2.848 2.848 0 0 0-2.176.902 2.847 2.847 0 0 1-4.16 0 2.85 2.85 0 0 0-2.176-.902 2.845 2.845 0 0 1-2.94-2.94 2.848 2.848 0 0 0-.901-2.176 2.848 2.848 0 0 1 0-4.16 2.849 2.849 0 0 0 .901-2.176 2.845 2.845 0 0 1 2.941-2.94 2.849 2.849 0 0 0 2.176-.901 2.847 2.847 0 0 1 4.159 0Z"/>
                        </svg>
                    ...
                    <div class="space-y-1">
                        ...
                        <p class="text-xs text-slate-600 dark:text-slate-300">
                            Complete Sales: ({{ $paid = $orders->where('is_paid')->count() }}) <span class="ms-1 inline-flex items-center gap-1.5 py-1 px-2 rounded-md text-xs font-medium bg-emerald-300 text-slate-800 dark:bg-emerald-700 dark:text-slate-100">
                ...
                <!-- This Week Sales -->
                <x-cards.simple-stats-card title="This Week">
                    <x-slot:svg>
                        <svg class="w-6 h-6 text-emerald-500 dark:text-emerald-600" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8.891 15.107 15.11 8.89m-5.183-.52h.01m3.089 7.254h.01M14.08 3.902a2.849 2.849 0 0 0 2.176.902 2.845 2.845 0 0 1 2.94 2.94 2.849 2.849 0 0 0 .901 2.176 2.847 2.847 0 0 1 0 4.16 2.848 2.848 0 0 0-.901 2.175 2.843 2.843 0 0 1-2.94 2.94 2.848 2.848 0 0 0-2.176.902 2.847 2.847 0 0 1-4.16 0 2.85 2.85 0 0 0-2.176-.902 2.845 2.845 0 0 1-2.94-2.94 2.848 2.848 0 0 0-.901-2.176 2.848 2.848 0 0 1 0-4.16 2.849 2.849 0 0 0 .901-2.176 2.845 2.845 0 0 1 2.941-2.94 2.849 2.849 0 0 0 2.176-.901 2.847 2.847 0 0 1 4.159 0Z"/>
                        </svg>
                    ...
                    <div class="space-y-1">
                        <h3 class="mb-1 text-xl font-medium text-amber-700 dark:text-amber-500">
                            {{ config('app.currency_symbol'). ' '. number_format($orders->sum('subtotal'), 2) }}
                        </h3>
                    </div>
                ...
                <!-- Customers sales -->
                <x-cards.simple-stats-card title="Customers">
                    <x-slot:svg>
                        <svg class="w-6 h-6 text-emerald-500 dark:text-emerald-600" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8.891 15.107 15.11 8.89m-5.183-.52h.01m3.089 7.254h.01M14.08 3.902a2.849 2.849 0 0 0 2.176.902 2.845 2.845 0 0 1 2.94 2.94 2.849 2.849 0 0 0 .901 2.176 2.847 2.847 0 0 1 0 4.16 2.848 2.848 0 0 0-.901 2.175 2.843 2.843 0 0 1-2.94 2.94 2.848 2.848 0 0 0-2.176.902 2.847 2.847 0 0 1-4.16 0 2.85 2.85 0 0 0-2.176-.902 2.845 2.845 0 0 1-2.94-2.94 2.848 2.848 0 0 0-.901-2.176 2.848 2.848 0 0 1 0-4.16 2.849 2.849 0 0 0 .901-2.176 2.845 2.845 0 0 1 2.941-2.94 2.849 2.849 0 0 0 2.176-.901 2.847 2.847 0 0 1 4.159 0Z"/>
                        </svg>
            ...
            <div class="lg:col-span-2 h-max grid md:grid-cols-2 border border-slate-200 shadow-sm rounded-xl overflow-hidden dark:border-slate-800">
                ...
                <!-- Sales Card -->
                <div class="block p-4 md:p-5 relative bg-slate-50 hover:bg-orange-100 before:absolute before:top-0 before:start-0 before:w-full before:h-px md:before:w-px md:before:h-full before:bg-gray-200 before:first:bg-transparent dark:bg-slate-700 dark:hover:bg-slate-900 dark:before:bg-slate-800">
                    <div class="flex md:grid lg:flex gap-y-3 gap-x-5">
                        <svg class="w-6 h-6 text-orange-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
            ...
            <div class="lg:col-span-2">
                <livewire:charts.sales-by-category-doughnut />
            </div>
        </div>
