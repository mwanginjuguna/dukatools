<x-app-layout>
    ...
    <div class="max-w-6xl mx-auto px-4 py-10 md:py-16 lg:py-24">
            ...
            <ol class="inline-flex items-center mb-3 space-x-1 md:space-x-2 rtl:space-x-reverse sm:mb-0">
                <li>
                    <div class="flex items-center">
                        <a href="#" class="ms-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ms-2 dark:text-gray-400 dark:hover:text-white">{{ config('app.name') }}</a>
                    </div>
                </li>
        ...
        <div class="py-3">
            <h1 class="py-2 text-slate-600 dark:text-slate-400">
                Product Details: <span class="text-lg md:text-2xl font-bold">{{ $product->name }}</span>
            </h1>
